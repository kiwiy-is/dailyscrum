...
ALTER TABLE ONLY "daily_scrum"."daily_scrum_update_entries"
    ADD CONSTRAINT "daily_scrum_daily_scrum_update_entries_submitted_user_id_fkey" FOREIGN KEY ("submitted_user_id") REFERENCES "public"."profiles"("id") ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE ONLY "public"."daily_scrum_update_entries"
    ADD CONSTRAINT "daily_scrum_update_entries_submitted_user_id_fkey1" FOREIGN KEY ("submitted_user_id") REFERENCES "auth"."users"("id");
