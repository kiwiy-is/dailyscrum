        ...
        <main className="flex-grow px-4 md:!px-8">
          <section className="py-10 max-w-4xl mx-auto">
            <div className="space-y-6 text-center pt-10">
              ...
              <p className={cn(p(), "")}>
                Share your updates in seconds, and keep daily team status in
                sync with a dedicated workspace board.
          ...
          <section className="py-10 max-w-2xl mx-auto">
            <div className="text-left">
              ...
              <p className={cn(p(), "")}>
                ...
                Answer daily scrum questions. Your responses will be
          ...
          <section className="py-10 max-w-2xl mx-auto">
            <div className="text-left">
              ...
              <h3 className={cn(h3(), "mt-8")}>
                Question form for quick update
              </h3>
              <p className={cn(p(), "")}>
          ...
          <section className="py-10 max-w-2xl mx-auto">
            <div className="text-left">
              ...
              <p className={cn(p(), "")}>
                Kiwiy Daily Scrum is entirely free to use. We hope to promote
                the overall happiness of the community by offering valuable
                tools at no cost.
              </p>
